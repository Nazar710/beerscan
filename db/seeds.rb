...
rod_tuborg = Beer.new(name: "Rod Tuborg", beer_story: "Red Tuborg is a dark, bottom-fermented lager beer that comes from Barvaria in Germany. Red Tuborg is a so-called all-malt beer, meaning that only malt and no raw grains (maize) are used. Four types of malt is used: münchener malt, pilsner malt and a bit of caramel and color malt. Together, these ingredients give the Tuborg yeast the distinctive reddish color, a very rich flavor and a rich foam. Ever since 1875, the Red Tuborg recipe has stayed the same.", upc: "5740700301544", alcohol: 6.8, temperature: 5, rating: 4)
...
brooklyn_summer_ale = Beer.new(name: "Hazesan Allihops", beer_story: "A hazy straw coloured New England style pale ale giving tropical and citrus flavours.", upc: "5740700301544", alcohol: 6.4, temperature: 8, rating: 4)
